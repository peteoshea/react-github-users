        ...
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <h3 className="text-lg leading-6 font-medium text-gray-900">
              {props.name}
              <span className="text-sm leading-5 text-gray-500 pl-2">@{props.login}</span>
            </h3>
            <p className="text-sm leading-5 text-gray-500">
              {props.public_repos} repositories. User since {props.created_at.slice(0, 4)}
            </p>
            <p className="text-sm leading-5 text-gray-500">{props.location || ''}</p>
      ...
      <div className="ml-4 mt-4 flex-shrink-0 flex">
        <span className="ml-3 inline-flex rounded-md shadow-sm">
          ...
          <button
            type="button"
            onClick={handleClick}
            className="ml-2 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-red-300 hover:text-gray-500 hover:bg-red-200 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:bg-red-200 active:text-gray-800"
          >
            <span>Delete</span>
          </button>
        </span>
